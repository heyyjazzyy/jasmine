              ...
              <section id="about" className="border-t border-border/60">
                <div className="grid grid-cols-1 lg:grid-cols-12">
                  <div className="lg:col-start-1 lg:col-end-13 px-6 lg:px-10 pt-16 lg:pt-20 pb-16 lg:pb-20">
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-6 gap-4 md:gap-0 items-start">
                      <img
                        src={portraitAsset.url}
                        alt="Portrait of Jasmine Liao"
                        className="w-36 h-48 md:w-[180px] md:h-[240px] lg:w-[220px] lg:h-[300px] object-cover rounded-sm md:col-span-2"
                      />
                      <p className="body-text whitespace-pre-line md:col-span-4 lg:col-span-3">
