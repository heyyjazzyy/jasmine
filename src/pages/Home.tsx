...
const Home = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 min-h-screen">
      ...
      <aside className="lg:col-span-2 bg-background border-r border-border/60 p-6 lg:p-8 lg:pt-12 flex flex-col justify-between lg:sticky lg:top-0 lg:h-screen">
        <div>
